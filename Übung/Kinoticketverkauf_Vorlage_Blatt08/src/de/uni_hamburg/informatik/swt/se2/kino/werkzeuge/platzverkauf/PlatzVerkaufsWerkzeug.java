...
import de.uni_hamburg.informatik.swt.se2.kino.werkzeuge.BarzahlungsWerkzeug;
...
public class PlatzVerkaufsWerkzeug
{
    ...
    private void fuehreBarzahlungDurch()
    {
        ...
        _barzahlungswerkzeug = new BarzahlungsWerkzeug(_gesamtpreis);

        if (_barzahlungswerkzeug.BetragWurdeBezahlt())
       {
